	...
	Sidebar.prototype.addMSCAECompaniesPalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'WebAppUmbraco.svg;',	
					r * 0.49, r * 0.5, '', 'WebAppUmbraco', null, null, this.getTagsForStencil(gn, 'webappumbraco drawio umbraco', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'WebAppWordPress.svg;',	
					r * 0.49, r * 0.5, '', 'WebAppWordPress', null, null, this.getTagsForStencil(gn, 'webappwordpress drawio wordpress', dt).join(' '))
		];
