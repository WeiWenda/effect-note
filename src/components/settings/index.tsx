...
import {
  Path, Document, DocumentStore, ClientStore, InMemory, Menu, Session,
  SessionComponent, SpinnerComponent, MenuComponent, KeyBindings, KeyMappings, BackendType, MODES
} from '../../share';
...
import BackendSettingsComponent from './backendSettings';
import FileInput from '../fileInput';
import BehaviorSettingsComponent from './behaviorSettings';
import {PluginsManager} from '../../ts/plugins';
import logger from '../../ts/logger';
import { downloadFile, exportFile, mimetypeLookup } from '../../ts/util';
...
export default class SettingsComponent extends React.Component<Props, State> {
  ...
  public render() {
    ...
    const applyTheme = (theme: Theme) => {
      ...
      appendStyleScript(session.clientStore);
      updateAll();
    };
            ...
            <div className='settings-content'>
              <div className='clearfix' style={{marginBottom: 10}}>
                ...
                <div className='btn'
                     ...
                     onClick={() => {
                       this.props.keyBindings?.setMappings(this.props.config.defaultMappings);
                ...
                <FileInput
                  ...
                  onLoad={(_filename, contents) => {
                    ...
                    this.props.keyBindings?.setMappings(mappings);
                    ...
                    return (
                      <div key={mode}>
                        ...
                        <HotkeysTableComponent
                          keyMap={this.props.keyBindings!.mappings.mappings[mode]}
                          definitions={this.props.keyBindings!.definitions}
                          clientStore={session.clientStore}
                        />
                      </div>
                    );
    ...
    if (this.props.initialBackendType) {
      tabs_info.unshift({
        tab: TABS.DATA,
        heading: 'Data',
        div: (
              ...
              <tr>
                <td>
                  <div className='btn'
                       ...
                       onClick={() => exportFile(session, 'json')} >
                    Export as JSON
                  </div>
                </td>
                <td>
              ...
              <tr>
                <td>
                  <div className='btn'
                       ...
                       onClick={() => exportFile(session, 'txt')}>
                    Export as plaintext
                  </div>
                </td>
                <td>
